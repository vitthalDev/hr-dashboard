            ...
            <Modal isOpen={true} className='modal-dialog-centered'>
                ...
                <ModalBody>
                    ...
                    <Col xs='12' className='pt-sm-1'>
                        ...
                        <Input type='radio' name='type' value='all' checked={coverType === 'all'} onChange={() => {
                            setCoverType('all')
                            props.toggleModal()
                        }
                        } />
                    ...
                    <Col xs='12' className='pt-sm-1'>
                        ...
                        <Input type='radio' name='type' value='health' checked={coverType === 'health'} onChange={() => {
                    ...
                    <Col xs='12' className='pt-sm-1'>
                        ...
                        <Input type='radio' name='type' value='life' checked={coverType === 'life'} onChange={() => {
                            setCoverType('life')
                            props.toggleModal()
                        }
                        } />
