...
const ToastContent = ({ name, role }) => (
  <Fragment>
    ...
    <div className='toastify-body'>
      <span>You have successfully logged in as an {role} user to eOxegen. Now you can start to explore. Enjoy!</span>
    </div>
  </Fragment>
)
    ...
    if (isObjEmpty(errors)) {
      useJwt
        ...
        .then(res => {
          ...
          toast.success(
            <ToastContent name={data.fullName || data.userName || 'User'} role={data.role || 'admin'} />,
        ...
        <Col className='d-flex align-items-center auth-bg px-2 p-lg-5' lg='4' sm='12'>
          <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
            ...
            <p className='text-center mt-2'>
              ...
              <Link>
                <span className='font-small-5 text-underline'>Customer Agreement</span>
              </Link>
            </p>
            ...
            <div className='auth-footer-btn d-flex justify-content-center'>
              <Button outline className='border my-1 d-flex justify-content-between col-8'>
              ...
              {/* <Button outline className='border my-1 d-flex justify-content-between col-8'>
                <span className='font-weight-bold font-large-1 text-warning'>
                  0
                </span>
