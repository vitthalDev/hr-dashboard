...
import { Breadcrumb, BreadcrumbItem, Nav, NavItem, NavLink, Row, TabContent, TabPane } from 'reactstrap'
      ...
      <Fragment>
        ...
        <TabContent className='py-50' activeTab={active}>
          ...
          <TabPane tabId='pastClaims'>
            <PastClaims primary={colors.primary.main}
              warning={colors.warning.main}
              danger={colors.danger.main}
              success={colors.success.main}></PastClaims>
          </TabPane>
