...
const ClaimAnalysis4 = () => {
    const claimCauseColumns = [
        { name: 'DISEASE CATEGORY', sortable: true, selector: 'category', minWidth: '400px' },
        { name: 'NO. OF CLAIMS', sortable: true, selector: 'noOfClaims', center: true },
        {
            name: 'CLAIM COST',
            sortable: true,
            selector: 'claimCost',
    ...
    const coveredMembersData = [
        { category: "Diseases of the digestive system", noOfClaims: '04', cost: '162,072' },
        { category: "Diseases of the circulatory system", noOfClaims: '02', cost: '88,495' },
        { category: "Injury, poisoning and certain other consequences of external causes", noOfClaims: '01', cost: '168,979' },
        { category: "Diseases of the genitourinary system", noOfClaims: '01', cost: '75,000' },
        { category: "Diseases of the respiratory system", noOfClaims: '01', cost: '24,807' },
        { category: "Factors influencing health status and contact with health services", noOfClaims: '01', cost: '14,652' },
