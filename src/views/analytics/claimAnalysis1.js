...
const ClaimAnalysis1 = () => {
    ...
    const [particularData, setParticularData] = useState(
        [
            ...
            { particular: "Total Claim Cost (Total Settled Amt. + Total Claimed Amt. for Outstanding)", values: '1,909,138' },
            { particular: "Total Premium Paid Till date (Exclusive of Taxes)", values: '6,586,762' },
    ...
    const particularColumns = [
        ...
        { name: 'VALUES', selector: 'values', sortable: true }
    ]
    const ratioSeries = [
        {
            data: [700, 350, 480]
            ...
            <Row className='claim-analytics'>
                <Col xs='12' lg='6'>
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle tag='h3'>
                                Status Wise Claim Summary and Claim Ratios
                            </CardTitle>
                        </CardHeader>
