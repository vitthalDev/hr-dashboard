      ...
      <div>
        ...
        <div>
          <span className="mr-25" style={{ color: color1 }}>
            <svg fill={color1} xmlns="http://www.w3.org/2000/svg" width="7" height="18" viewBox="0 0 13.5 36">
